...
void team1::display(){
    ...
    cout<<"\tCaptain:"<<captain<<endl<<endl;
    cfile<<"\tCaptain:"<<captain<<endl<<endl;
...
class match:public team1,public team2{
    class dat{
        ...
        int getDate(){
            ...
            int p;
            if(k==2){
                p=1+rand()%28;              // k=2 , month feb
            }
            else if((k<8 && k%2==1) || (k>=8 && k%2==0)){       // k<8 and even 31 days
                p=1+rand()%31;
            }
            else{
                p=1+rand()%30;
...
void match :: display(){
    ...
    if(team1::winOrLose==1){
        cout<<"Team 1:"<<team1::teamName<<" Won!!"<<endl<<endl;
        cfile<<"Team 1:"<<team1::teamName<<" Won!!"<<endl<<endl;
    }
    else{
        cout<<"Team2:"<<team2::teamName<<" Won!!"<<endl<<endl;
        cfile<<"Team2:"<<team2::teamName<<" Won!!"<<endl<<endl;
    }
...
class series{
    ...
    public:
        ...
        series(int p){
            ...
            m=new match[n];
            for(int i=0;i<n;i++){
                cout<<"MATCH::"<<i+1<<endl<<endl;
                cfile<<"MATCH::"<<i+1<<endl<<endl;
                m[i]=match();
                t1=(team1)m[i];
                t1.display();
                t2=(team2)m[i];
